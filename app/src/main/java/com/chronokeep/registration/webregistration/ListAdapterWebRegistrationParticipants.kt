...
class ListAdapterWebRegistrationParticipants(var objects: MutableList<DatabaseParticipant>, private val frag: Fragment) :
    RecyclerView.Adapter<ListAdapterWebRegistrationParticipants.ParticipantView>() {
    private val tag: String = "Chrono.PartLA"

    private var searchString = ""

    class ParticipantView(private val adapter: ListAdapterWebRegistrationParticipants, view: View) :
    ...
    fun assignBib(position: Int) {
        ...
        val bibFrag = FragmentWebAssignParticipantBib(participant = participant)
    ...
    fun editParticipant(position: Int) {
        ...
        val participant = objects[position]
        val editFrag = FragmentWebEditParticipant(participant = participant)
        frag.requireActivity().supportFragmentManager.beginTransaction()
