...
class ActivityWebRegistration: AppCompatActivity(), ChronoActivity {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction().replace(R.id.registration_fragment_container, FragmentWebRegistrationParticipants()).commit()
            setActivityTitle("Chronokeep Web Registration")
        }
